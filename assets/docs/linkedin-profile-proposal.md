# LinkedIn profile proposal

This copy is intentionally in English to match the current profile and portfolio. It keeps Habi as one Product Designer experience while stating the title transition clearly.

## Headline

Senior Product Designer & Product Builder | Mobile, Data & B2B SaaS | From Research and Metrics to Production

## About

I'm a Senior Product Designer and product builder. I turn ambiguous business problems and complex data into products teams can ship, measure, and improve.

My work spans UX research, product analytics, interaction design, mobile-first journeys, design systems, and hands-on frontend implementation with React, Next.js, Vue/Nuxt, and TypeScript. I'm most useful when a project needs someone who can connect user needs, business decisions, and technical constraints, and stay involved through production.

Recently, I've helped ship a self-serve SaaS platform in six weeks, built an internal analytics product that connected six data sources, and redesigned a mobile acquisition flow that increased qualified conversion by 30%.
...
**Location:** Remote | U.S.-based B2B PropTech SaaS
...
**Dates:** Aug 2022 - Jun 2024 (1 yr 11 mos)
...
- Designed a role-based operations platform for commercial and zone leaders managing teams, territories, and assignments across multiple cities, replacing spreadsheet-heavy workflows and aligning behavior with the internal CRM.
- Conducted cross-functional UX research and built and iterated AI-assisted customer-service prompts; also contributed to brand systems and multi-channel campaigns.
...
Secondary skills: Mobile Design, A/B Testing, Design Systems, Data Visualization, Prototyping, Front-End Development, React.js, TypeScript, B2B SaaS.
